...
scf(3)
plot2d((1:(size(y_C_o_a)(2)))/rate,y_C_o_a,1)
plot2d((1:(size(y_Ha_o_a)(2)))/rate,y_Ha_o_a,2)
plot2d((1:(size(y_He_o_a)(2)))/rate,y_He_o_a,3)
plot2d((1:(size(y_Pi_o_a)(2)))/rate,y_Pi_o_a,4)
xlabel('Tempo (s)')
ylabel('Amplitude')
legend(['Caique';'Hattori';'Heitor';'Paiva'])
...
scf(8)
plot2d((1:(size(y_C_a_f)(2)))/rate,y_C_a_f,1)
plot2d((1:(size(y_He_a_f)(2)))/rate,y_He_a_f,3)
plot2d((1:(size(y_Pi_a_f)(2)))/rate,y_Pi_a_f,4)
//plot(y_Pk_a_f,x,5)
xlabel('Tempo (s)')
ylabel('Amplitude')
legend(['Caique';'Heitor';'Paiva'])
...
scf(9)
plot2d((1:(size(y_C_e_f)(2)))/rate,y_C_e_f,1)
plot2d((1:(size(y_Ha_e_f)(2)))/rate,y_Ha_e_f,2)
plot2d((1:(size(y_He_e_f)(2)))/rate,y_He_e_f,3)
plot2d((1:(size(y_Pi_e_f)(2)))/rate,y_Pi_e_f,4)
xlabel('Tempo (s)')
ylabel('Amplitude')
legend(['Caique';'Hattori';'Heitor';'Paiva'])
...
scf(10)
plot2d((1:(size(y_C_o_f)(2)))/rate,y_C_o_f,1)
plot2d((1:(size(y_Ha_o_f)(2)))/rate,y_Ha_o_f,2)
plot2d((1:(size(y_He_o_f)(2)))/rate,y_He_o_f,3)
plot2d((1:(size(y_Pi_o_f)(2)))/rate,y_Pi_o_f,4)
xlabel('Tempo (s)')
ylabel('Amplitude')
legend(['Caique';'Hattori';'Heitor';'Paiva'])
